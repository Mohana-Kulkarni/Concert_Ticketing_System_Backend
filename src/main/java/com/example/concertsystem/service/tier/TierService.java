...
public interface TierService {
    void addTier(String name, int capacity, int price, String eventId) throws ExecutionException, InterruptedException;
...
//    int getAvailableSeats();
    void updateTier(String id, String name, int capacity, int price, String eventId) throws ExecutionException, InterruptedException;
    ...
    Tier getTierByNameEventId(String name, String eventId) throws ExecutionException, InterruptedException;
