...
public class EventController {
    ...
    public void addEvent(@RequestBody Event event) throws ExecutionException, InterruptedException {
        eventService.addEvent(event.name(), event.dateAndTime(), event.description(), event.venueId(), event.userId(), event.tierId());
    }
    ...
    public void updateEventById(@PathVariable String id, @RequestBody Event event) throws ExecutionException, InterruptedException {
        eventService.updateEvent(id, event.name(), event.dateAndTime(), event.description(), event.venueId(), event.userId(), event.tierId());
    }
