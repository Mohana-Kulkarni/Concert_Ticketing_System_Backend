...
public class TicketController {
    ...
    @GetMapping("/id")
    public TicketResponse getTicketById(@RequestParam("id") String id) throws ExecutionException, InterruptedException {
        return ticketService.getTicketById(id);
    }

    @GetMapping("/user")
    public TicketResponse getTicketByName(@RequestParam("user") String user) throws ExecutionException, InterruptedException {
    ...
    @PutMapping("/id")
    public void updateTicketById(@RequestParam("id") String id, @RequestBody Ticket ticket) throws ExecutionException, InterruptedException {
